...
//            st.executeUpdate("create table services(serviceId int AUTO_INCREMENT primary key, serviceName varchar(200), price int, description varchar(500))");
            st.executeUpdate("create table customer_services(id int AUTO_INCREMENT primary key, customerId int, serviceId int, usageDate varchar(50), quantity int, foreign key (customerId) references customer(id), foreign key (serviceId) references services(serviceId))");
